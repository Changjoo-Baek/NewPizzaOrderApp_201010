package com.zzazzu.newpizzaorderapp_201010.fragments
...
class PizzaStoreFragment  : Fragment() {
    ...
    override fun onCreatView(
        ...
        return inflater.inflate(R.layout_fragment_pizza_store, container, false)
    }
    ...
    override fun OnActivityCreated(SavedInstanceState: Bundle?) {
        ...
        mStoreAdapter = StoreAdapter(context!!, R.layout_store_list_item, mPizzaStoreList)
        ...
        pizzaStoreListView.setOnItemClickListener {parent, view, position, id ->
            ...
            val myIntent = Intent(context, ViewStoreDetailAcitivity::class.java)
